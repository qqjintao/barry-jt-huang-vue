  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="用户昵称(中文)" align="center" prop="nickNameZh" :show-overflow-tooltip="true" />
          <el-table-column label="用户昵称(英文)" align="center" prop="nickNameEn" :show-overflow-tooltip="true" />
          <el-table-column label="邮箱" align="center" prop="email" :show-overflow-tooltip="true" />
          <el-table-column label="手机号码" align="center" prop="phone" width="120" />
          <el-table-column prop="sex" label="性别" :formatter="sexFormat" width="80" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="用户昵称" prop="nickNameZh">
              <el-input v-model="form.nickNameZh" placeholder="请输入用户昵称(中文)" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="用户昵称" prop="nickNameEn">
              <el-input v-model="form.nickNameEn" placeholder="请输入用户昵称(英文)" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="归属部门" prop="deptIds">
              <treeselect multiple v-model="form.deptIds" :options="deptOptions" :show-count="true" placeholder="请选择归属部门" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="岗位" prop="postIds">
              <el-select v-model="form.postIds" multiple placeholder="请选择">
                <el-option v-for="item in postOptions" :key="item.id" :label="item.postNameZh" :value="item.id"
          ...
          <el-col :span="24">
            <el-form-item label="角色">
              <el-select v-model="form.roleIds" multiple placeholder="请选择">
                <el-option v-for="item in roleOptions" :key="item.id" :label="item.roleNameZh" :value="item.id"
                  :disabled="item.status == 1"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
    ...
    methods: {
      ...
      currDeptChange() {
        if (this.form.deptIds.length > 0) {
          getPostByDeptIds(this.form.deptIds).then(response => {
      ...
      handleUpdate(row) {
        ...
        getUser(id).then(response => {
          this.form = Object.assign({}, this.form, response.data.list);
          this.roleOptions = response.data.roles;
